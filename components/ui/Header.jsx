                    ...
                    <div className="collapse-content px-1">
                        <ul className="flex flex-col gap-2">
                            ...
                            <li className="flex gap-5 lg-plus:gap-3 items-center">
                                <Link href="https://github.com/devlarabar" target="_blank" className="flex gap-2 items-center" aria-label="GitHub">
                            ...
                            <li className="flex gap-5 lg-plus:gap-3 items-center">
                                <Link href="https://twitter.com/devlarabar" target="_blank" className="flex gap-2 items-center" aria-label="X/Twitter">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
                            ...
                            <li className="flex gap-5 lg-plus:gap-3 items-center">
                                <Link href="https://www.linkedin.com/in/lara-sa/" target="_blank" className="flex gap-2 items-center" aria-label="LinkedIn">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
                    ...
                    <ul className="flex items-center gap-10">
                        ...
                        <li className="flex gap-5 lg-plus:gap-3 items-center">
                            <Link href="https://github.com/devlarabar" target="_blank" className="flex gap-2 items-center" aria-label="GitHub">
                                ...
                                <span className="hidden 2xs:block ">GitHub</span>
                            </Link>
                        </li>
                        <li className="flex gap-5 lg-plus:gap-3 items-center">
                            <Link href="https://twitter.com/devlarabar" target="_blank" className="flex gap-2 items-center" aria-label="X/Twitter">
                                ...
                                <span className="hidden 2xs:block ">Twitter</span>
                            </Link>
                        </li>
                        <li className="flex gap-5 lg-plus:gap-3 items-center">
                            <Link href="https://www.linkedin.com/in/lara-sa/" target="_blank" className="flex gap-2 items-center" aria-label="LinkedIn">
                                ...
                                <span className="hidden 2xs:block ">LinkedIn</span>
                            </Link>
                        </li>
                        <li className="flex gap-5 lg-plus:gap-3 items-center">
                            <Link href="/resume/Lara-Alexander_Resume.pdf" target="_blank" className="flex gap-2 items-center" aria-label="Resume">
                                <DocumentCheckIcon className="hidden lg:block w-6 h-6" />
                                <span className="hidden 2xs:block ">Resume</span>
                            </Link>
                        </li>
                        {/* <li>
                            <Link
