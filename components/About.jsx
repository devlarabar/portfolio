...
const About = () => {
    return (
        <div className="lg-plus:max-w-[320px] flex flex-col sm:flex-row lg-plus:flex-col items-center gap-6 max-w-[100vw]">
                ...
                <ul className="mt-3">
                    ...
                    <li className="flex gap-5 lg-plus:gap-3 mt-4 items-center">
                        <a href="https://github.com/devlarabar" className="flex gap-2 items-center" aria-label="GitHub">
                            ...
                            <span className="hidden xs:block lg-plus:hidden">GitHub</span>
                        </a>
                        <a href="https://twitter.com/devlarabar" className="flex gap-2 items-center" aria-label="X/Twitter">
                            ...
                            <span className="hidden xs:block lg-plus:hidden">Twitter</span>
                        </a>
                        <a href="https://www.linkedin.com/in/lara-sa/" className="flex gap-2 items-center" aria-label="LinkedIn">
                            ...
                            <span className="hidden xs:block lg-plus:hidden">LinkedIn</span>
                        </a>
                    </li>
                </ul>
            </div>
