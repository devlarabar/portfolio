        ...
        <div className="flex flex-col gap-4 w-full">
            ...
            <form method="POST" name="contact" id="contactForm" data-netlify="true" className="flex flex-col gap-4">
                ...
                <div className="flex gap-4 lg-plus:flex-col">
                    <input type="text" className="input input-bordered w-full" name="name" id="name" value="" placeholder="Name" />
                    <input type="email" className="input input-bordered w-full" name="email" id="email" value="" placeholder="Email" />
                </div>
